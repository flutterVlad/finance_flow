...
class WeeklyExpense extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<HomeBloc, HomeState>(
      builder: (context, state) {
        final expenses = ExpenseDataTransformer.transform(
          state.curWeekExpenses,
        );
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          'From ${state.startOfWeek.day} - ${state.endOfWeek.day} ${state.endOfWeek.strMonthShort}, 2025',
                ...
                AspectRatio(
                  aspectRatio: 1.5,
                  child: ScatterChart(scatterData(expenses)),
                ),
                GridView.builder(
                  shrinkWrap: true,
                  padding: .zero,
  ...
  ScatterChartData scatterData(List<ExpenseData> expenses) {
    return ScatterChartData(
      scatterSpots: expenses
          .map((e) => CustomScatterSpot(expenseData: e))
          .toList(),
      minX: 0,
      maxX: 20,
      minY: 0,
        ...
        touchTooltipData: ScatterTouchTooltipData(
          ...
          getTooltipItems: (ScatterSpot scatterSpot) {
            return ScatterTooltipItem(
              (scatterSpot as CustomScatterSpot).expenseData.formattedAmount,
            );
          },
        ),
      ),
...
class CustomScatterSpot extends ScatterSpot {
  final ExpenseData expenseData;

  CustomScatterSpot({required this.expenseData})
    : super(
        expenseData.x,
        expenseData.y,
...
class ExpenseDataTransformer {
  ...
  // Преобразует входящие данные в ExpenseData
  static List<ExpenseData> transform(List<Expense> inputData) {
  ...
  static List<(double, double)> _generateForceDirectedPositions(
    ...
    final positions = List.generate(count, (index) {
      ...
      final startRadius = min(4.0, fieldSize / 4); // Начальный радиус
      return (
